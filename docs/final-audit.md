...
| Store in free Supabase Postgres             | ⏳     | Schema/migrations ready (`prisma/migrations/`); needs your Supabase project connection string                                                                 |

## Submission requirements

| Requirement                         | Status                                                                                                                                    |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Live deployment on Render Free Tier | ⏳ Blueprint ready (`render.yaml`), Dockerfile verified end-to-end locally (build + run + `/health` 200), needs your Render account login |
